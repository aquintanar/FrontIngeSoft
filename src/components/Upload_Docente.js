...
const UploadAsesor = ({ label, files,linkDoc,tituloDoc, nombreArchivo,idAlumno,idEntregable,idVersion,estadoEntregable,tieneDocumento,setFiles, ...otherProps }) => {
  var archivo="";
  var tamanho=0;
...
const [documentosVersionCalificada , setDocumentosVersionCalificada ] = useState([]);
...
var i=0;
      for(i=0;i<dataDocumentos.length;i++){
        ...
        documentosVersionCalificada[i] = dataDocumentos[i];
           }
      }
      
      setDocumentosVersionCalificada(documentosVersionCalificada);
    ...
    <>
      ...
      " " )}
        ...
        <PreviewList>
              ...
              {((idVersion >= 0) ? documentosVersionCalificada.map((documentos) => {
                   return (
          ...
          files.map((file, index) => {
            ...
            versionSeleccionada.documentosRetroalimentación = fileName;
            archivo = fileName;
       ...
       //     else documentoVersionNuevo.idVersion = 41;  //ACA DEBERIA IR LAS VERSIONES CREADAS
            ...
            documentoVersionNuevo.esTarea = 0;
