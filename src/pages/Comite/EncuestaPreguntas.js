...
function EncuestaPreguntas() {
    ...
    const cargaRubricas=async()=>{
        if(id!=='0'){
            const response = await axios.get("https://localhost:7012/api/DetallePreguntaEncuesta/BuscarDetallePreguntaEncuestaXId?idDetallePreguntaEncuesta="+parseInt(id));
