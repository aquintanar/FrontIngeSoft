...
function GestionarCurso() {
  ...
  const petitionCurso = async () => {
    ...
    await axios
      .get(urlCur + "ListarCursosXIdComiteTesis?idComiteTesis=" + idUs)
      .then((response) => {
  ...
  const petitionCursoDocente = async () => {
    ...
    await axios
      .get(
        "http://34.195.33.246/api/Curso/ListarCursosXIdDocente?idDocente=" +
          idUs
      )
      .then((response) => {
  ...
  const petitionCursoComite = async () => {
    ...
    await axios
      .get(
        "http://34.195.33.246/api/Curso/ListarCursosXIdComiteTesis?idComiteTesis=" +
          idUs
      )
      .then((response) => {
        console.log(response.data);
  ...
  const petitionCursoAsesor = async () => {
    ...
    await axios
      .get(
        "http://34.195.33.246/api/Curso/ListarCursosXIdAsesor?idAsesor=" + idUs
      )
      .then((response) => {
        console.log(response.data);
        setData(response.data);
  ...
  const petitionCursoAlumno = async () => {
    ...
    await axios
      .get(
        "http://34.195.33.246/api/Curso/ListarCursosXIdAlumno?idAlumno=" + idUs
      )
      .then((response) => {
        console.log(response.data);
        setData(response.data);
