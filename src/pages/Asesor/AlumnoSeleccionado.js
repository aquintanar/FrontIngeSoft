...
function AlumnoSeleccionado(){
    ...
    return(
        <div className='CONTAINERASESOR'>
            ...
            <a class="BTN-CUADRADO" onClick={() =>navigate("avancesSemanales",{state:{idAlumno:location.state.idAlumno,nombres:location.state.nombres,apellidoPat:location.state.apellidoPat,apellidoMaterno:location.state.apellidoMat, idCurso: localStorage.getItem('idCurso')}})}>Avances Semanales</a>

            <a class="BTN-CUADRADO" onClick={() =>navigate("entregables",{state:{idAlumno:location.state.idAlumno,nombres:location.state.nombres,apellidoPat:location.state.apellidoPat,apellidoMaterno:location.state.apellidoMat, idCurso: localStorage.getItem('idCurso')}})}>Entregables</a>
