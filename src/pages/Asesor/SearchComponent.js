                                ...
                                <tr key = {temasTesis.idTemaTesis}>
                                    ...
                                    {(() => {
                                        switch(temasTesis.estadoTema){
                                            ...
                                            case "Pendiente" : return <td class = "text-warning">{temasTesis.estadoTema}</td> ;
                                            case "Desaprobado" : return <td class = "text-danger">{temasTesis.estadoTema}</td> ;
                                            default: return <td>asdasd</td>
                                        }
                                    }) ()}
                                    </td>
