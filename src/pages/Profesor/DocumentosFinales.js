...
function DocumentosFinales(){
  ...
  const getData=async()=> {
    (async () => {
      const result = await fetch(`http://34.195.33.246/api/Entregable/ListEntregablesXIdCursoYIdTipoEntregableYIdAlumno?idCurso=${location.state.idCurso}&idTipoEntregable=9&idAlumno=${location.state.idAlumno}`);
