...
const getInformacion = async() => {
  ...
  const urlTema  = 'http://34.195.33.246/api/TemaTesis/GetTemaTesisXIdCurso?idCurso='+localStorage.getItem('idCurso');
  ...
  const urlDocente  = 'http://34.195.33.246/api/Curso/BuscarCursoXId?idCurso='+localStorage.getItem('idCurso');
